...
//  YXClient
//
//  Created by 张明磊 on 14-6-9.
//  Copyright (c) 2014年 张明磊. All rights reserved.
//

#import "AppDelegate.h"
#import "YXHomeController.h"
#import "YXLeftController.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    YXHomeController *controller_root = [[YXHomeController alloc] init];
    YXLeftController *controller_left = [[YXLeftController alloc] init];
    ...
    sideMenuViewController.backgroundImage = [UIImage imageFileName:@"left_0.png"];
